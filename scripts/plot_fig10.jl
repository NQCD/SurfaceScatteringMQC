...
function plot_both_models()
    ...
    plot_single_model!(axes[1,1], "NOAu", energy_limits, energy_levels, 15.0)
    plot_single_model!(axes[1,2], "NOAu", energy_limits, energy_levels, 0.15)
    ...
    padding = (1,1,1,1)
    Label(fig[0,1], "Γ = 15.0 eV"; padding, tellwidth=false, tellheight=true)
    Label(fig[0,2], "Γ = 0.15 eV"; padding, tellwidth=false, tellheight=true)

    return fig
end

save_figure(plotsdir("fig10_adiabatic_surfaces.png"), plot_both_models, fontsize=9)
